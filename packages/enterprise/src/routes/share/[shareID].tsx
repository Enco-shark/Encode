import { Message, Model, Part, Session, SessionStatus, SnapshotFileDiff, UserMessage } from "@encode-ai/sdk/v2"
import { SessionTurn } from "@encode-ai/ui/session-turn"
import { SessionReview } from "@encode-ai/ui/session-review"
import { DataProvider } from "@encode-ai/ui/context"
import { FileComponentProvider } from "@encode-ai/ui/context/file"
import { WorkerPoolProvider } from "@encode-ai/ui/context/worker-pool"
import { createAsync, query, useParams } from "@solidjs/router"
import { createMemo, createSignal, ErrorBoundary, For, Match, Show, Switch } from "solid-js"
import { Share } from "~/core/share"
import { Logo, Mark } from "@encode-ai/ui/logo"
import { IconButton } from "@encode-ai/ui/icon-button"
import { ProviderIcon } from "@encode-ai/ui/provider-icon"
import { iife } from "@encode-ai/shared/util/iife"
...
import { Tabs } from "@encode-ai/ui/tabs"
import { MessageNav } from "@encode-ai/ui/message-nav"
import { FileSSR } from "@encode-ai/ui/file-ssr"
...
const ClientOnlyWorkerPoolProvider = clientOnly(() =>
  import("@encode-ai/ui/pierre/worker").then((m) => ({
      ...
      <Show when={data()}>
        {(data) => {
          ...
          const ogImage = createMemo(() => {
            ...
            return `https://social-cards.sst.dev/encode-share/${encodedTitle}.png?model=${modelParam}&version=${version}&id=${data().shareID}`
          })

          return (
            <>
              <Show when={info().title}>
                <Title>{info().title} | Encode</Title>
              </Show>
              <Meta name="description" content="Encode - The AI coding agent built for the terminal." />
                        ...
                        <div class="relative bg-background-stronger w-screen h-screen overflow-hidden flex flex-col">
                          <header class="h-12 px-6 py-2 flex items-center justify-between self-stretch bg-background-base border-b border-border-weak-base">
                            ...
                            <div class="flex gap-3 items-center">
                              <IconButton
                                as={"a"}
                                href="https://github.com/anomalyco/encode"
                                target="_blank"
                                icon="github"
                                variant="ghost"
                              />
