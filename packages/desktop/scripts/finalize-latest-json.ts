...
const releaseId = process.env.ENCODE_RELEASE
if (!releaseId) throw new Error("ENCODE_RELEASE is required")

const version = process.env.ENCODE_VERSION
if (!version) throw new Error("ENCODE_VERSION is required")
...
const macxTarGz = "encode-desktop-mac-x64.app.tar.gz"
const macaTarGz = "encode-desktop-mac-arm64.app.tar.gz"
