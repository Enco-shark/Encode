...
const dir = path.join(os.tmpdir(), "ENCODE-test-data-" + process.pid)
...
process.env["ENCODE_TEST_TMPDIR_ROOT"] = fixtureRoot
afterAll(async () => {
...
process.env["ENCODE_MODELS_PATH"] = path.join(import.meta.dir, "tool", "fixtures", "models-api.json")
...
process.env["ENCODE_TEST_MANAGED_CONFIG_DIR"] = testManagedConfigDir
process.env["ENCODE_DISABLE_DEFAULT_PLUGINS"] = "true"

// Write the cache version file to prevent global/index.ts from clearing the cache
const cacheDir = path.join(dir, "cache", "ENCODE")
...
delete process.env["ENCODE_SERVER_PASSWORD"]
delete process.env["ENCODE_SERVER_USERNAME"]
delete process.env["ENCODE_HOME"]

// Use in-memory sqlite
process.env["ENCODE_DB"] = ":memory:"
