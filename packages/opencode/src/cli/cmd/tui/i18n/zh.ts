...
export const dict = {
  ...
  "tui.tips.config_files":
    "创建 {highlight}encode.json{/highlight} 用于服务端配置，{highlight}tui.json{/highlight} 用于 TUI 配置",
  "tui.tips.global_config": "把 TUI 配置放在 {highlight}~/.config/encode/tui.json{/highlight} 作为全局配置",
  ...
  "tui.tips.mcp_oauth": "Encode 自动处理需要鉴权的远程 MCP 服务器的 OAuth",
  "tui.tips.custom_command":
    "在 {highlight}.encode/command/{/highlight} 添加 {highlight}.md{/highlight} 文件以定义可复用自定义提示",
  ...
  "tui.tips.custom_agent":
    "在 {highlight}.encode/agent/{/highlight} 添加 {highlight}.md{/highlight} 文件来创建专用 AI 角色",
  ...
  "tui.tips.formatter": "Encode 自动使用 prettier、gofmt、ruff 等格式化文件",
  ...
  "tui.tips.lsp": "Encode 使用 LSP 服务器进行智能代码分析",
  "tui.tips.custom_tool":
    "在 {highlight}.encode/tools/{/highlight} 创建 {highlight}.ts{/highlight} 文件定义新的 LLM 工具",
  "tui.tips.tool_scripts": "工具定义可以调用 Python、Go 等脚本",
  "tui.tips.plugins":
    "在 {highlight}.encode/plugin/{/highlight} 添加 {highlight}.ts{/highlight} 文件挂接事件钩子",
  "tui.tips.plugin_notify": "用插件在会话完成时发送系统通知",
  "tui.tips.plugin_protect": "写一个插件阻止 Encode 读取敏感文件",
  "tui.tips.run": "用 {highlight}Encode run{/highlight} 进行非交互式脚本调用",
  "tui.tips.continue": "用 {highlight}Encode --continue{/highlight} 继续上一个会话",
  "tui.tips.attach_cli": "用 {highlight}Encode run -f file.ts{/highlight} 通过命令行附加文件",
  "tui.tips.format_json": "用 {highlight}--format json{/highlight} 在脚本中获得机器可读输出",
  "tui.tips.serve": "运行 {highlight}Encode serve{/highlight} 以无头模式提供 Encode API",
  "tui.tips.attach_server": "用 {highlight}Encode run --attach{/highlight} 接入正在运行的服务",
  "tui.tips.upgrade": "运行 {highlight}Encode upgrade{/highlight} 升级到最新版本",
  "tui.tips.auth_list": "运行 {highlight}Encode auth list{/highlight} 查看所有已配置的 provider",
  "tui.tips.agent_create": "运行 {highlight}Encode agent create{/highlight} 引导式创建智能体",
  "tui.tips.github_trigger": "在 GitHub issue/PR 中输入 {highlight}/opencode{/highlight} 触发 AI 操作",
  "tui.tips.github_install": "运行 {highlight}Encode github install{/highlight} 配置 GitHub workflow",
  ...
  "tui.tips.theme_files": "在 {highlight}.encode/themes/{/highlight} 目录下创建 JSON 主题文件",
  ...
  "tui.tips.debug_config": "运行 {highlight}Encode debug config{/highlight} 排查配置问题",
  ...
  "tui.tips.zen": "使用 {highlight}/connect{/highlight} 设置你喜欢的 LLM 服务商",
  ...
  "tui.voice.error.no_auth": "语音功能暂不可用",
  ...
  "tui.dialog.login.Encode_free": "Encode (免费)",
  "tui.dialog.login.Encode_free.desc": "免费匿名通道，无需登录",
  "tui.dialog.login.Encode_free.success": "Encode (免费) 已就绪 - 默认模型设为 Encode/Encode-auto",
  "tui.dialog.login.Encode_free.unavailable": "Encode (免费) 通道未加载",
  "cli.providers.select": "选择服务商",
  "cli.providers.other": "其他 Provider",
  "cli.providers.Encode.recommended_hint": "推荐",
  "cli.providers.Encode_free.hint": "免费匿名通道 / Encode-auto",
  "cli.providers.Encode_free.verifying": "正在验证 Encode (免费) 通道...",
  "cli.providers.Encode_free.ready": "Encode (免费) 通道已就绪",
  "cli.providers.Encode_free.failed": "Encode (免费) 自检失败",
  "cli.providers.Encode_free.default_set": "默认模型已切换为 Encode/Encode-auto（1M 上下文，免费）",
  "cli.providers.Encode_free.usage_hint": "无需登录，直接 Encode run 即可使用。",
  "cli.providers.Encode_login.decrypt_retry": "解密失败，请重试 (剩余 {remaining} 次)",
  "cli.providers.Encode_login.decrypt_exhausted": "解密失败，已达最大重试次数",
  ...
  "tui.dialog.login.flow.title": "服务商登录",
