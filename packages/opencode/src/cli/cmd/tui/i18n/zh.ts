...
export const dict = {
  ...
  "tui.dialog.login.Encode_free.success": "MiMo Auto (free) 已就绪 - 默认模型设为 Encode/Encode-auto",
  "tui.dialog.login.Encode_free.unavailable": "MiMo Auto (free) 通道未加载",
  ...
  "cli.providers.Encode_free.verifying": "正在验证 MiMo Auto (free) 通道...",
  "cli.providers.Encode_free.ready": "MiMo Auto (free) 通道已就绪",
  "cli.providers.Encode_free.failed": "MiMo Auto (free) 自检失败",
  "cli.providers.Encode_free.default_set": "默认模型已切换为 Encode/Encode-auto（1M 上下文，免费）",
  "cli.providers.Encode_free.usage_hint": "无需登录，直接 Encode run 即可使用。如需付费/更高级模型，可重新选择 MiMo 浏览器登录。",
