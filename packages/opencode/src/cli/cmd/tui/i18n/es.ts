...
export const dict = {
  ...
  "tui.tips.config_files":
    "Crea {highlight}encode.json{/highlight} para la configuración del servidor y {highlight}tui.json{/highlight} para la TUI",
  "tui.tips.global_config":
    "Coloca la configuración de TUI en {highlight}~/.config/encode/tui.json{/highlight} como configuración global",
  "tui.tips.schema":
  ...
  "tui.tips.custom_agent":
    "Añade archivos {highlight}.md{/highlight} en {highlight}.encode/agent/{/highlight} para personajes de IA especializados",
  ...
  "tui.tips.plugins":
    "Añade archivos {highlight}.ts{/highlight} en {highlight}.encode/plugin/{/highlight} para enganchar eventos",
  ...
  "tui.tips.continue":
    "Usa {highlight}Encode --continue{/highlight} para retomar la última sesión",
  "tui.tips.attach_cli":
    "Usa {highlight}Encode run -f file.ts{/highlight} para adjuntar archivos vía CLI",
  ...
  "tui.tips.upgrade":
    "Ejecuta {highlight}Encode upgrade{/highlight} para actualizar a la última versión",
  "tui.tips.auth_list":
  ...
  "tui.tips.debug_config":
    "Ejecuta {highlight}Encode debug config{/highlight} para diagnosticar problemas de configuración",
  "tui.tips.print_logs":
