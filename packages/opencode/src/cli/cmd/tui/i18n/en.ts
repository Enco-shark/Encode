export const dict: Record<string, string> = {
  ...
  "tui.dialog.login.Encode_free.success": "MiMo Auto (free) is ready — default model set to Encode/Encode-auto",
  "tui.dialog.login.Encode_free.unavailable": "MiMo Auto (free) provider not loaded",
  ...
  "cli.providers.Encode_free.verifying": "Verifying MiMo Auto (free) channel...",
  "cli.providers.Encode_free.ready": "MiMo Auto (free) channel ready",
  "cli.providers.Encode_free.failed": "MiMo Auto (free) verification failed",
  "cli.providers.Encode_free.default_set": "Default model set to Encode/Encode-auto (1M context, free)",
  "cli.providers.Encode_free.usage_hint": "No login required — just run Encode. For paid/premium models, choose MiMo browser login instead.",
