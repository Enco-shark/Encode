export const dict: Record<string, string> = {
  ...
  "tui.tips.zen": "Use {highlight}/connect{/highlight} to set up your preferred LLM provider",
  ...
  "tui.voice.error.no_auth": "Voice feature is not available",
  ...
  "tui.dialog.login.Encode_free": "Encode (free)",
  "tui.dialog.login.Encode_free.desc": "Anonymous free channel — no login required",
  "tui.dialog.login.Encode_free.success": "Encode (free) is ready — default model set to Encode/Encode-auto",
  "tui.dialog.login.Encode_free.unavailable": "Encode (free) provider not loaded",
  ...
  "cli.providers.Encode_free.verifying": "Verifying Encode (free) channel...",
  "cli.providers.Encode_free.ready": "Encode (free) channel ready",
  "cli.providers.Encode_free.failed": "Encode (free) verification failed",
  "cli.providers.Encode_free.default_set": "Default model set to Encode/Encode-auto (1M context, free)",
  "cli.providers.Encode_free.usage_hint": "No login required — just run Encode.",
  ...
  "tui.dialog.login.flow.title": "Provider Login",
