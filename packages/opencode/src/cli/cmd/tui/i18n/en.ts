export const dict: Record<string, string> = {
  // Language names
  "language.en": "English",
  "language.zh": "ÁÆÄ‰Ωì‰∏≠Ôø?,
  "language.zht": "ÁπÅÈ´î‰∏≠Êñá",
  "language.ko": "ÌïúÍµ≠Ôø?,
  "language.de": "Deutsch",
  "language.es": "Espa√±ol",
  "language.fr": "Fran√ßais",
  "language.da": "Dansk",
  "language.ja": "Êó•Êú¨Ôø?,
  "language.pl": "Polski",
  "language.ru": "–†—É—Å—Å–∫–∏–π",
  "language.ar": "ÿßŸÑÿπÿ±ÿ®Ÿäÿ©",
  "language.no": "Norsk",
  "language.br": "Portugu√™s (Brasil)",
  ...
  "tui.tips.free_models": "Free models are available for a limited time Ôø?try them now!",
  "tui.tips.background":
  ...
  "tui.tips.config_files":
    "Create {highlight}encode.json{/highlight} for server settings and {highlight}tui.json{/highlight} for TUI settings",
  "tui.tips.global_config": "Place TUI settings in {highlight}~/.config/encode/tui.json{/highlight} for global config",
  ...
  "tui.tips.mcp_oauth": "encode auto-handles OAuth for remote MCP servers requiring auth",
  "tui.tips.custom_command":
    "Add {highlight}.md{/highlight} files to {highlight}.encode/command/{/highlight} to define reusable custom prompts",
  ...
  "tui.tips.custom_agent":
    "Add {highlight}.md{/highlight} files to {highlight}.encode/agent/{/highlight} for specialized AI personas",
  ...
  "tui.tips.formatter": "encode auto-formats files using prettier, gofmt, ruff, and more",
  ...
  "tui.tips.lsp": "encode uses LSP servers for intelligent code analysis",
  "tui.tips.custom_tool":
    "Create {highlight}.ts{/highlight} files in {highlight}.encode/tools/{/highlight} to define new LLM tools",
  "tui.tips.tool_scripts": "Tool definitions can invoke scripts written in Python, Go, etc",
  "tui.tips.plugins":
    "Add {highlight}.ts{/highlight} files to {highlight}.encode/plugin/{/highlight} for event hooks",
  "tui.tips.plugin_notify": "Use plugins to send OS notifications when sessions complete",
  "tui.tips.plugin_protect": "Create a plugin to prevent encode from reading sensitive files",
  "tui.tips.run": "Use {highlight}Encode run{/highlight} for non-interactive scripting",
  "tui.tips.continue": "Use {highlight}Encode --continue{/highlight} to resume the last session",
  "tui.tips.attach_cli": "Use {highlight}Encode run -f file.ts{/highlight} to attach files via CLI",
  "tui.tips.format_json": "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "tui.tips.serve": "Run {highlight}Encode serve{/highlight} for headless API access to encode",
  "tui.tips.attach_server": "Use {highlight}Encode run --attach{/highlight} to connect to a running server",
  "tui.tips.upgrade": "Run {highlight}Encode upgrade{/highlight} to update to the latest version",
  "tui.tips.auth_list": "Run {highlight}Encode auth list{/highlight} to see all configured providers",
  "tui.tips.agent_create": "Run {highlight}Encode agent create{/highlight} for guided agent creation",
  "tui.tips.github_trigger": "Use {highlight}/opencode{/highlight} in GitHub issues/PRs to trigger AI actions",
  "tui.tips.github_install": "Run {highlight}Encode github install{/highlight} to set up the GitHub workflow",
  ...
  "tui.tips.theme_files": "Create JSON theme files in {highlight}.encode/themes/{/highlight} directory",
  ...
  "tui.tips.debug_config": "Run {highlight}Encode debug config{/highlight} to troubleshoot configuration",
  ...
  "tui.tips.zen": "Use {highlight}/connect{/highlight} with Encode for curated, tested models",
  ...
  "tui.command.never_ask.title_on": "Never-ask: ON Ôø?turn off (ask me again)",
  "tui.command.never_ask.title_off": "Never-ask: OFF Ôø?turn on (decide without asking)",
  "tui.command.never_ask.toast_on":
    "Never-ask ON Ôø?I won't prompt you; I'll pick the best option myself until you turn it off (/never-ask-questions). Permission requests still need your approval.",
  "tui.command.never_ask.toast_off": "Never-ask OFF Ôø?I'll ask you at decision points again.",
  ...
  "tui.dialog.image.import.option": "Choose new imageÔø?,
  ...
  "tui.command.voice.toggle.title_on": "Voice input: ON Ôø?click to turn off",
  "tui.command.voice.toggle.title_off": "Voice input: OFF Ôø?click to turn on",
  "tui.command.voice.send.title": "Toggle voice send command",
  "tui.command.voice.send.title_on": "Voice send: ON Ôø?click to turn off",
  "tui.command.voice.send.title_off": "Voice send: OFF Ôø?click to turn on",
  "tui.voice.enabled": "Voice input on (Chinese/English) Ôø?click [Voice] to record",
  "tui.voice.disabled": "Voice input disabled",
  "tui.voice.send.enabled": "Voice send enabled Ôø?after a pause, clearly say \"send it\" to submit",
  "tui.voice.send.disabled": "Voice send disabled",
  "tui.voice.control.enabled": "Voice control enabled Ôø?using multimodal model for intelligent editing (slower)",
  "tui.voice.control.disabled": "Voice control disabled Ôø?using fast ASR transcription",
  "tui.command.voice.control.title": "Toggle voice control (multimodal)",
  "tui.command.voice.control.title_on": "Voice control: ON (multimodal) Ôø?click to turn off",
  "tui.command.voice.control.title_off": "Voice control: OFF (fast ASR) Ôø?click to turn on",
  "tui.voice.error.no_auth": "Please log in to Encode first",
  ...
  "tui.dialog.login.Encode_free.desc": "Anonymous free channel Ôø?no login required",
  "tui.dialog.login.Encode_free.success": "Encode Auto (free) is ready Ôø?default model set to Encode/Encode-auto",
  "tui.dialog.login.Encode_free.unavailable": "Encode Auto (free) provider not loaded",
  "cli.providers.select": "Select provider",
  "cli.providers.other": "Other provider",
  "cli.providers.Encode.recommended_hint": "recommended",
  "cli.providers.Encode_free.hint": "Anonymous free channel / Encode-auto",
  "cli.providers.Encode_free.verifying": "Verifying Encode Auto (free) channel...",
  "cli.providers.Encode_free.ready": "Encode Auto (free) channel ready",
  "cli.providers.Encode_free.failed": "Encode Auto (free) verification failed",
  "cli.providers.Encode_free.default_set": "Default model set to Encode/Encode-auto (1M context, free)",
  "cli.providers.Encode_free.usage_hint": "No login required Ôø?just run Encode. For paid/premium models, choose Encode browser login instead.",
  "cli.providers.Encode_login.decrypt_retry": "Decryption failed, please retry ({remaining} attempts left)",
  "cli.providers.Encode_login.decrypt_exhausted": "Decryption failed, max retries reached",
  ...
  "tui.dialog.login.flow.title": "Encode Login",
