...
import { I18nProvider } from "@encode-ai/ui/context/i18n"
...
const loaders: Record<Exclude<Locale, "en">, () => Promise<Dictionary>> = {
  zh: () => merge(import("@encode-ai/ui/i18n/zh"), import("../i18n/zh")),
  zht: () => merge(import("@encode-ai/ui/i18n/zht"), import("../i18n/zht")),
  ko: () => merge(import("@encode-ai/ui/i18n/ko")),
  de: () => merge(import("@encode-ai/ui/i18n/de")),
  es: () => merge(import("@encode-ai/ui/i18n/es"), import("../i18n/es")),
  fr: () => merge(import("@encode-ai/ui/i18n/fr"), import("../i18n/fr")),
  da: () => merge(import("@encode-ai/ui/i18n/da")),
  ja: () => merge(import("@encode-ai/ui/i18n/ja"), import("../i18n/ja")),
  pl: () => merge(import("@encode-ai/ui/i18n/pl")),
  ru: () => merge(import("@encode-ai/ui/i18n/ru"), import("../i18n/ru")),
  ar: () => merge(import("@encode-ai/ui/i18n/ar")),
  no: () => merge(import("@encode-ai/ui/i18n/no")),
  br: () => merge(import("@encode-ai/ui/i18n/br")),
  th: () => merge(import("@encode-ai/ui/i18n/th")),
  bs: () => merge(import("@encode-ai/ui/i18n/bs")),
  tr: () => merge(import("@encode-ai/ui/i18n/tr")),
}
