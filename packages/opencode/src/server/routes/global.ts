...
export const GlobalRoutes = lazy(() =>
  new Hono()
    .get(
      ...
      describeRoute({
        summary: "Get health",
        description: "Get health information about the Encode server.",
    ...
    .get(
      ...
      describeRoute({
        ...
        description: "Subscribe to global events from the Encode system using server-sent events.",
    ...
    .get(
      ...
      describeRoute({
        ...
        description: "Retrieve the current global Encode configuration settings and preferences.",
    ...
    .patch(
      ...
      describeRoute({
        ...
        description: "Update global Encode configuration settings and preferences.",
    ...
    .post(
      ...
      describeRoute({
        ...
        description: "Clean up and dispose all Encode instances, releasing all resources.",
    ...
    .post(
      "/upgrade",
      describeRoute({
        summary: "Upgrade Encode",
        description: "Upgrade Encode to the specified version or latest if not specified.",
