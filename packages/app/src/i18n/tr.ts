...
export const dict = {
  ...
  "dialog.provider.encode.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.encode.tagline": "Güvenilir optimize edilmiş modeller",
  "dialog.provider.encodeGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "dialog.model.unpaid.freeModels.title": "Encode tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve Encode'da {{provider}} modellerini kullanmak için {{provider}} API anahtarınızı girin.",
  ...
  "provider.connect.encodeZen.line1":
    "Encode Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.encodeZen.visit.prefix": "",
  "provider.connect.encodeZen.visit.link": "encode.ai/zen",
  "provider.connect.encodeZen.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
  "provider.connect.oauth.code.visit.prefix":
    "Hesabınızı bağlamak ve Encode'da {{provider}} modellerini kullanmak için ",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak Encode'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler encode.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi Encode sunucusuna bağlanacağını değiştirin.",
  ...
  "toast.update.description": "Encode'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı Encode ekibine bildirin",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (encode.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: Encode henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "Encode ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "Encode Masaüstü",
  ...
  "settings.desktop.wsl.description": "Encode sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "Encode'un görünüm dilini değiştirin",
  "settings.general.row.appearance.title": "Görünüm",
  "settings.general.row.appearance.description": "Encode'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "Encode'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Encode'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "Encode başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "Encode'un en son sürümünü kullanıyorsunuz.",
