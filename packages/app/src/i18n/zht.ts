...
export const dict = {
  ...
  "dialog.provider.encode.note": "精選模型，包含 Claude、GPT、Gemini 等等",
  "dialog.provider.encode.tagline": "可靠的優化模型",
  "dialog.provider.encodeGo.tagline": "適合所有人的低成本訂閱",
  ...
  "dialog.model.unpaid.freeModels.title": "Encode 提供的免費模型",
  ...
  "provider.connect.apiKey.description":
    "輸入你的 {{provider}} API 金鑰以連線帳戶，並在 Encode 中使用 {{provider}} 模型。",
  ...
  "provider.connect.encodeZen.line1": "Encode Zen 為你提供一組精選的可靠最佳化模型，用於程式碼代理程式。",
  "provider.connect.encodeZen.line2": "只需一個 API 金鑰，你就能使用 Claude、GPT、Gemini、GLM 等模型。",
  "provider.connect.encodeZen.visit.prefix": "造訪 ",
  "provider.connect.encodeZen.visit.link": "encode.ai/zen",
  "provider.connect.encodeZen.visit.suffix": " 取得你的 API 金鑰。",
  "provider.connect.oauth.code.visit.prefix": "造訪 ",
  "provider.connect.oauth.code.visit.link": "此連結",
  "provider.connect.oauth.code.visit.suffix": " 取得授權碼，以連線你的帳戶並在 Encode 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " 並輸入以下程式碼，以連線你的帳戶並在 Encode 中使用 {{provider}} 模型。",
  ...
  "dialog.plugins.empty": "在 encode.json 中設定的外掛程式",
  ...
  "dialog.server.description": "切換此應用程式連線的 Encode 伺服器。",
  ...
  "toast.update.description": "Encode 有新版本 ({{version}}) 可安裝。",
  ...
  "error.page.report.prefix": "請將此錯誤回報給 Encode 團隊",
  ...
  "error.chain.checkConfig": "請檢查你的設定 (encode.json) 中的 provider/model 名稱",
  "error.chain.mcpFailed": 'MCP 伺服器 "{{name}}" 啟動失敗。注意: Encode 暫不支援 MCP 認證。',
  ...
  "sidebar.gettingStarted.line1": "Encode 提供免費模型，你可以立即開始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 上的 WSL 中執行 Encode 伺服器。",
  ...
  "settings.general.row.language.description": "變更 Encode 的顯示語言",
  "settings.general.row.appearance.title": "外觀",
  "settings.general.row.appearance.description": "自訂 Encode 在你的裝置上的外觀",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "選擇 Encode 要跟隨系統、淺色或深色主題",
  "settings.general.row.theme.title": "主題",
  "settings.general.row.theme.description": "自訂 Encode 的主題。",
  ...
  "settings.updates.row.startup.description": "在 Encode 啟動時自動檢查更新",
