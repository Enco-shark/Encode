...
export default function TermsOfService() {
  ...
  return (
    <main data-page="legal">
      <Title>Encode | Terms of Service</Title>
      <LocaleLinks path="/legal/terms-of-service" />
      <Meta name="description" content="Encode terms of service" />
        ...
        <div data-component="content">
          <section data-component="brand-content">
            <article data-component="terms-of-service">
              ...
              <p>
                Welcome to Encode. Please read on to learn the rules and restrictions that govern your use of
                Encode&apos;s website, inference product and hosted software offering (the "Services"). If you have
              ...
              <p>
                ...
                <strong>ANOMALY INNOVATIONS, INC.</strong> ("Encode," "we" and "us"). Your use of the Services in any
                ...
                <a href={language.route("/legal/privacy-policy")}>https://encode.ai/legal/privacy-policy</a>.{" "}
                <strong>
              ...
              <p>
                Encode is an AI-powered coding agent that helps you write, understand, and modify code using large
                language models. Certain of these large language models are provided by third parties ("Third Party
                Models") and certain of these models are provided directly by us if you use the Encode Zen paid
                offering ("Zen"). Regardless of whether you use Third Party Models or Zen, Encode enables you to
              ...
              <p>
                ...
                our site located at encode.ai, send you an email, and/or notify you by some other means.
              </p>
              ...
              <p>
                Encode takes the privacy of its users very seriously. For the current Encode Privacy Policy, please
                click here{" "}
                <a href="https://encode.ai/legal/privacy-policy">https://encode.ai/legal/privacy-policy</a>.
              </p>
              ...
              <h2 id="what-are-the-basics">What are the basics of using Encode?</h2>
              <p>
              ...
              <ol style="list-style-type: lower-alpha;">
                ...
                <li>
                  ...
                  privacy laws or any other purpose not reasonably intended by Encode;
                </li>
                <li>
              ...
              <p>
                If you use Encode with Third Party Models, then your Content will be subject to the data retention
              ...
              <p>
                ...
                Encode. Your ability to access Third Party Models is contingent on you having API keys or otherwise
                having the right to access such Third Party Models.
              </p>

              <p>
                Encode has no control over, and assumes no responsibility for, the content, accuracy, privacy
              ...
              <h2 id="will-encode-ever-change-the-services">Will Encode ever change the Services?</h2>
              <p>
              ...
              <p>
                ...
                <a href={language.route("/zen")}>https://encode.ai/zen</a> for a description of the current Paid
              ...
              <p>
                ...
                <a href="https://encode.ai/auth">https://encode.ai/auth</a>.
              </p>
              ...
              <p>
                ...
                <a href={language.route("/legal/privacy-policy")}>https://encode.ai/legal/privacy-policy</a>, as well
                as the licenses above, to understand how we treat information you provide to us after you have stopped
                using our Services.
              </p>

              <p>
                Encode is also free to terminate (or suspend access to) your use of the Services for any reason in our
                discretion, including your breach of these Terms. Encode has the sole right to decide whether you are
              ...
              <p>
                Encode and its licensors, suppliers, partners, parent, subsidiaries or affiliated entities, and each
                of their respective officers, directors, members, employees, consultants, contract employees,
                representatives and agents, and each of their respective successors and assigns (Encode and all such
                parties together, the "Encode Parties") make no representations or warranties concerning the Services,
                including without limitation regarding any Content contained in or accessed through the Services, and
                the Encode Parties will not be responsible or liable for the accuracy, copyright compliance, legality,
                ...
                participation in, the Services. The Encode Parties make no representations or warranties regarding
              ...
              <h3>Indemnity</h3>
              <p>
                You agree to indemnify and hold the Encode Parties harmless from and against any and all claims,
              ...
              <p>
                ...
                Services account, in any way (by operation of law or otherwise) without Encode's prior written
              ...
              <p>
                ...
                disputes and claims with Encode and limits the manner in which you can seek relief from Encode. Both
                you and Encode acknowledge and agree that for the purposes of any dispute arising out of or relating
                to the subject matter of these Terms, Encode's officers, directors, employees and independent
              ...
              <p>
                The Rules will govern payment of all arbitration fees. Encode will pay all arbitration fees for claims
                less than seventy-five thousand ($75,000) dollars. Encode will not seek its attorneys' fees and costs
                in arbitration unless the arbitrator determines that your claim is frivolous.
              </p>

              <h4>Small Claims Court; Infringement</h4>
              <p>
                Either you or Encode may assert claims, if they qualify, in small claims court in New Castle County,
              ...
              <p>
                ...
                OF A JUDGE OR JURY. You and Encode are instead choosing to have claims and disputes resolved by
                ...
                you and Encode over whether to vacate or enforce an arbitration award, YOU AND OPENCODE WAIVE ALL
              ...
              <p>
                ...
                Encode is entitled to arbitration; instead all claims and disputes will be resolved in a court as set
                forth in (g) below.
              </p>
              ...
              <p>
                ...
                agreement permits either you or Encode to litigate any dispute arising out of or relating to the
                subject matter of these Terms in court, then the foregoing arbitration agreement will not apply to
                either party, and both you and Encode agree that any judicial proceeding (other than small claims
              ...
              <p>
                ...
                the Encode may, in its sole discretion, do any of the foregoing on your behalf or for itself as it
                ...
                Terms shall otherwise remain in full force and effect and enforceable. You and Encode agree that these
                Terms are the complete and exclusive statement of the mutual understanding between you and Encode, and
                ...
                are not an employee, agent, partner, or joint venture of Encode, and you do not have any authority of
                any kind to bind Encode in any respect whatsoever.
              </p>

              <p>
                Except as expressly set forth in the section above regarding the arbitration agreement, you and Encode
