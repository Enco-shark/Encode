...
import { IconMiniMax, IconEncode, IconZai, IconAlibaba } from "~/component/icon"
...
const models = [
  ...
  { name: "encode-v2-Pro", provider: "Encode" },
  { name: "encode-v2-Omni", provider: "Encode" },
...
function LimitsGraph(props: { href: string }) {
  ...
  const graph = [
    ...
    { id: "encode-v2-pro", name: "encode-v2-Pro", req: 1290, d: "150ms" },
