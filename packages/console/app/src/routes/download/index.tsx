...
import desktopAppIcon from "../../asset/lander/encode-desktop-icon.png"
      ...
      <div data-component="container">
        ...
        <div data-component="content">
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button
                ...
                onClick={handleCopyClick("curl -fsSL https://encode.ai/install | bash")}
              >
                <code>
                  curl -fsSL https://<strong>encode.ai/install</strong> | bash
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("npm i -g encode-ai")}>
                <code>
                  npm i -g <strong>encode-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("bun add -g encode-ai")}>
                <code>
                  bun add -g <strong>encode-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("brew install anomalyco/tap/encode")}>
                <code>
                  brew install <strong>anomalyco/tap/encode</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("paru -S encode")}>
                <code>
                  paru -S <strong>encode</strong>
                </code>
                <CopyStatus />
              </button>
            </div>
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button data-component="cli-row" onClick={handleCopyClick("brew install --cask encode-desktop")}>
                <code>
                  brew install --cask <strong>encode-desktop</strong>
                </code>
                <CopyStatus />
              </button>
