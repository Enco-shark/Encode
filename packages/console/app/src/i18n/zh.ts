...
export const dict = {
  ...
  "notFound.title": "未找到页�?| Encode",
  "notFound.heading": "404 - 页面未找�?,
  "notFound.home": "首页",
  "notFound.docs": "文档",
  "notFound.github": "GitHub",
  "notFound.discord": "Discord",
  "notFound.logoLightAlt": "encode logo 亮色",
  "notFound.logoDarkAlt": "encode logo 暗色",

  "user.logout": "退出登�?,

  "auth.callback.error.codeMissing": "未找到授权码�?,

  "workspace.select": "选择工作�?,
  "workspace.createNew": "+ 新建工作�?,
  "workspace.modal.title": "新建工作�?,
  "workspace.modal.placeholder": "输入工作区名�?,
  ...
  "error.invalidPlan": "无效的计�?,
  "error.workspaceRequired": "缺少工作�?ID",
  ...
  "app.meta.description": "Encode - 开源编程代理�?,

  "home.title": "Encode | 开�?AI 编程代理",

  "temp.title": "Encode | 专为终端打造的 AI 编程代理",
  "temp.hero.title": "专为终端打造的 AI 编程代理",
  "temp.zen": "Encode Zen",
  "temp.getStarted": "开始使�?,
  "temp.feature.native.title": "原生 TUI",
  "temp.feature.native.body": "响应迅速、原生的、可定制主题的终�?UI",
  "temp.feature.zen.beforeLink": "�?Encode 提供�?,
  "temp.feature.zen.link": "精选模型列�?,
  "temp.feature.zen.afterLink": "",
  "temp.feature.models.beforeLink": "通过 Models.dev 支持 75+ LLM 提供�?,
  "temp.feature.models.afterLink": "，包括本地模�?,
  "temp.screenshot.caption": "使用 Tokyonight 主题�?Encode TUI",
  "temp.screenshot.alt": "使用 Tokyonight 主题�?Encode TUI",
  "temp.logoLightAlt": "encode logo 亮色",
  "temp.logoDarkAlt": "encode logo 暗色",

  "home.banner.badge": "�?,
  "home.banner.text": "桌面应用 Beta 版现已推�?,
  "home.banner.platforms": "支持 macOS, Windows, �?Linux",
  "home.banner.downloadNow": "立即下载",
  "home.banner.downloadBetaNow": "立即下载桌面 Beta �?,

  "home.hero.title": "开�?AI 编程代理",
  "home.hero.subtitle.a": "内置免费模型，或连接任意提供商的任意模型�?,
  "home.hero.subtitle.b": "包括 Claude, GPT, Gemini 等�?,

  "home.install.ariaLabel": "安装选项",

  "home.what.title": "什么是 Encode�?,
  "home.what.body": "Encode 是一个开源代理，帮助您在终端、IDE 或桌面端编写代码�?,
  "home.what.lsp.title": "支持 LSP",
  "home.what.lsp.body": "�?LLM 自动加载合适的 LSP",
  "home.what.multiSession.title": "多会�?,
  ...
  "home.what.copilot.body": "使用 GitHub 登录以使用您�?Copilot 账户",
  "home.what.chatgptPlus.title": "ChatGPT Plus/Pro",
  "home.what.chatgptPlus.body": "使用 OpenAI 登录以使用您�?ChatGPT Plus �?Pro 账户",
  "home.what.anyModel.title": "任意模型",
  "home.what.anyModel.body": "通过 Models.dev 支持 75+ LLM 提供商，包括本地模型",
  "home.what.anyEditor.title": "任意编辑�?,
  "home.what.anyEditor.body": "提供终端界面、桌面应用及 IDE 扩展",
  "home.what.readDocs": "阅读文档",

  "home.growth.title": "开�?AI 编程代理",
  "home.growth.body":
    "拥有超过 <strong>{{stars}}</strong> �?GitHub Star�?strong>{{contributors}}</strong> 位贡献者，以及超过 <strong>{{commits}}</strong> 次提交，Encode 每月被超�?<strong>{{monthlyUsers}}</strong> 名开发者使用并信赖�?,
  "home.growth.githubStars": "GitHub Stars",
  "home.growth.contributors": "贡献�?,
  "home.growth.monthlyDevs": "月活开发�?,

  "home.privacy.title": "隐私优先的设�?,
  "home.privacy.body": "Encode 不存储您的任何代码或上下文数据，确保可以在对隐私敏感的环境中运行�?,
  "home.privacy.learnMore": "了解更多关于",
  "home.privacy.link": "隐私",

  "home.faq.q1": "什么是 Encode�?,
  "home.faq.a1": "Encode 是一个开源代理，帮助您使用任�?AI 模型编写和运行代码。它提供终端界面、桌面应用及 IDE 扩展�?,
  "home.faq.q2": "如何使用 Encode�?,
  "home.faq.a2.before": "最简单的入门方式是阅�?,
  "home.faq.a2.link": "介绍",
  "home.faq.q3": "使用 Encode 需要额外的 AI 订阅吗？",
  "home.faq.a3.p1": "不一定。Encode 自带一组免费模型，无需创建账户即可使用�?,
  "home.faq.a3.p2.beforeZen": "此外，您可以通过创建",
  "home.faq.a3.p2.afterZen": "账户来使用流行的编程模型�?,
  "home.faq.a3.p3": "虽然我们鼓励使用 Zen，但 Encode 也支持所有主流提供商，如 OpenAI, Anthropic, xAI 等�?,
  "home.faq.a3.p4.beforeLocal": "您甚至可以连接您�?,
  "home.faq.a3.p4.localLink": "本地模型",
  "home.faq.q4": "我可以使用现有的 AI 订阅吗？",
  "home.faq.a4.p1":
    "可以，Encode 支持所有主流提供商的订阅计划。您可以使用您的 Claude Pro/Max, ChatGPT Plus/Pro, �?GitHub Copilot 订阅�?,
  "home.faq.q5": "Encode 只能在终端使用吗�?,
  "home.faq.a5.beforeDesktop": "不再是了！Encode 现在也提�?,
  "home.faq.a5.desktop": "桌面端应�?,
  "home.faq.a5.and": "�?,
  "home.faq.a5.web": "网页�?,
  "home.faq.q6": "Encode 多少钱？",
  "home.faq.a6": "Encode �?100% 免费使用的。它还自带一组免费模型。如果您连接其他提供商，可能会产生额外费用�?,
  "home.faq.q7": "数据和隐私如何？",
  "home.faq.a7.p1": "只有当您使用我们的免费模型或创建分享链接时，您的数据和信息才会被存储�?,
  "home.faq.a7.p2.beforeModels": "了解更多关于",
  "home.faq.a7.p2.modelsLink": "我们的模�?,
  "home.faq.a7.p2.and": "�?,
  "home.faq.a7.p2.shareLink": "分享页面",
  "home.faq.q8": "Encode 是开源的吗？",
  "home.faq.a8.p1": "是的，Encode 是完全开源的。源代码公开�?,
  "home.faq.a8.p2": "遵循",
  "home.faq.a8.mitLicense": "MIT 许可�?,
  "home.faq.a8.p3":
    "，这意味着任何人都可以使用、修改或为它的发展做贡献。社区中的任何人都可以提�?issue、提�?PR 并扩展功能�?,

  "home.zenCta.title": "访问可靠、优化的编程代理模型",
  "home.zenCta.body":
    "Zen 为您提供一组精选的 AI 模型，这些模型经�?Encode 专门针对编程代理的测试和基准测试。无需担心不同提供商之间不稳定的性能和质量，直接使用行之有效的验证模型�?,
  "home.zenCta.link": "了解 Zen",

  "zen.title": "Encode Zen | 为编程代理精选的可靠、优化模�?,
  "zen.hero.title": "为编程代理打造的可靠、优化模�?,
  "zen.hero.body":
    "Zen 为您提供一组精选的 AI 模型，这些模型经�?Encode 专门针对编程代理的测试和基准测试。无需担心不稳定的性能和质量，直接使用行之有效的验证模型�?,

  "zen.faq.q1": "什么是 Encode Zen�?,
  "zen.faq.a1": "Zen 是一组由 Encode 团队创建的，专门针对编程代理进行测试和基准测试的 AI 模型精选集�?,
  "zen.faq.q2": "为什�?Zen 更准确？",
  "zen.faq.a2":
    "Zen 仅提供经过专门针对编程代理测试和基准测试的模型。正如你不会用黄油刀切牛排一样，也不要用糟糕的模型来写代码�?,
  "zen.faq.q3": "Zen 更便宜吗�?,
  "zen.faq.a3":
    "Zen 不以盈利为目的。Zen 将模型提供商的成本直接传递给您。Zen 的使用量越高，Encode 就越能协商出更好的费率并回馈给您�?,
  "zen.faq.q4": "Zen 多少钱？",
  "zen.faq.a4.p1.beforePricing": "Zen",
  "zen.faq.a4.p1.pricingLink": "按请求收�?,
  "zen.faq.a4.p1.afterPricing": "零加价，所以您只需支付模型提供商收取的费用�?,
  "zen.faq.a4.p2.beforeAccount": "您的总费用取决于使用量，且您可以在您�?,
  "zen.faq.a4.p2.accountLink": "账户中设置每月支出限�?,
  "zen.faq.a4.p3": "为覆盖成本，Encode 仅收取少量支付处理费，每充�?$20 收取 $1.23�?,
  "zen.faq.q5": "数据和隐私如何？",
  "zen.faq.a5.beforeExceptions": "所�?Zen 模型均托管在美国。提供商遵循零留存政策，不使用您的数据进行模型训练，",
  "zen.faq.a5.exceptionsLink": "以下例外情况除外",
  "zen.faq.q6": "我可以设置支出限额吗�?,
  "zen.faq.a6": "可以，您可以在账户中设置每月支出限额�?,
  "zen.faq.q7": "我可以取消吗�?,
  "zen.faq.a7": "可以，您可以随时禁用计费并使用剩余余额�?,
  "zen.faq.q8": "我可以在其他编程代理中使�?Zen 吗？",
  "zen.faq.a8":
    "虽然 Zen �?Encode 配合效果极佳，但您可以在任何代理中使�?Zen。请按照您首选编程代理中的设置说明进行操作�?,

  "zen.cta.start": "开始使�?Zen",
  "zen.pricing.title": "充�?$20 (即用即付)",
  ...
  "zen.problem.subtitle": "我们要为所有人解决这个问题，不仅仅�?Encode 用户�?,
  "zen.problem.item1": "测试精选模型并咨询其团�?,
  "zen.problem.item2": "与提供商合作确保正确交付",
  "zen.problem.item3": "对所有推荐的模型-提供商组合进行基准测�?,
  "zen.how.title": "Zen 如何工作",
  "zen.how.body": "虽然我们建议您配�?Encode 使用 Zen，但您也可以将其用于任何代理�?,
  "zen.how.step1.title": "注册并充�?$20",
  ...
  "zen.how.step3.body": "当您的余额低�?$5 时，我们将自动充�?$20",
  "zen.privacy.title": "您的隐私对我们很重要",
  "zen.privacy.beforeExceptions": "所�?Zen 模型均托管在美国。提供商遵循零留存政策，不使用您的数据进行模型训练，",
  "zen.privacy.exceptionsLink": "以下例外情况除外",

  "go.title": "Encode Go | 人人可用的低成本编程模型",
  "go.meta.description":
    "Go 首月 $5，之�?$10/月，提供�?GLM-5.1、GLM-5、Kimi K2.5、Kimi K2.6、encode-v2-Pro、encode-v2-Omni、Qwen3.5 Plus、Qwen3.6 Plus、MiniMax M2.5 �?MiniMax M2.7 �?5 小时充裕请求额度�?,
  ...
  "go.cta.price": "$10/�?,
  "go.cta.promo": "首月 $5",
  "go.pricing.body": "可配合任何代理使用。首�?$5，之�?$10/月。如有需要可充值。随时取消�?,
  "go.banner.badge": "3x",
  "go.banner.text": "Kimi K2.6 使用额度提升�?3 倍，限时�?4 �?27 �?,
  "go.graph.free": "免费",
  "go.graph.freePill": "Big Pickle 和免费模�?,
  "go.graph.go": "Go",
  "go.graph.label": "�?5 小时请求�?,
  "go.graph.usageLimits": "使用限制",
  "go.graph.tick": "{{n}}x",
  "go.graph.aria": "�?5 小时请求�? {{free}} vs {{go}}",

  "go.testimonials.brand.zen": "Zen",
  "go.testimonials.brand.go": "Go",
  "go.testimonials.handle": "@Encode",
  "go.testimonials.dax.name": "Dax Raad",
  "go.testimonials.dax.title": "�?CEO, Terminal Products",
  "go.testimonials.dax.quoteAfter": "彻底改变了我的生活，这绝对是不二之选�?,
  "go.testimonials.jay.name": "Jay V",
  "go.testimonials.jay.title": "前创始人, SEED, PM, Melt, Pop, Dapt, Cadmus, �?ViewPoint",
  "go.testimonials.jay.quoteBefore": "我们团队 5 个人里有 4 个都爱用",
  "go.testimonials.jay.quoteAfter": "�?,
  "go.testimonials.adam.name": "Adam Elmore",
  "go.testimonials.adam.title": "�?Hero, AWS",
  "go.testimonials.adam.quoteBefore": "我强烈推�?,
  "go.testimonials.adam.quoteAfter": "。真的，非常好用�?,
  "go.testimonials.david.name": "David Hill",
  "go.testimonials.david.title": "前设计主�? Laravel",
  ...
  "go.testimonials.frank.title": "前实习生, Nvidia (4 �?",
  "go.testimonials.frank.quote": "我希望我还在 Nvidia�?,
  "go.problem.title": "Go 解决了什么问题？",
  "go.problem.body":
    "我们致力于将 Encode 体验带给尽可能多的人。Encode Go 是一款低成本订阅服务：首�?$5，之�?$10/月。它提供充裕的额度，并让您能可靠地使用最强大的开源模型�?,
  "go.problem.subtitle": " ",
  "go.problem.item1": "低成本订阅定�?,
  "go.problem.item2": "充裕的限额和可靠的访�?,
  "go.problem.item3": "为尽可能多的程序员打�?,
  "go.problem.item4":
    "包含 GLM-5.1, GLM-5, Kimi K2.5、Kimi K2.6, encode-v2-Pro, encode-v2-Omni, Qwen3.5 Plus, Qwen3.6 Plus, MiniMax M2.5 �?MiniMax M2.7",
  "go.how.title": "Go 如何工作",
  "go.how.body": "Go 起价为首�?$5，之�?$10/月。您可以将其�?Encode 或任何代理搭配使用�?,
  ...
  "go.how.step3.title": "开始编�?,
  "go.how.step3.body": "可靠访问开源模�?,
  ...
  "go.faq.q1": "什么是 Encode Go�?,
  "go.faq.a1": "Go 是一项低成本订阅服务，为您提供对强大的开源模型的可靠访问，用于代理编程�?,
  "go.faq.q2": "Go 包含哪些模型�?,
  "go.faq.a2": "Go 包含下方列出的模型，提供充足的限额和可靠的访问�?,
  "go.faq.q3": "Go �?Zen 一样吗�?,
  "go.faq.a3":
    "不。Zen 是按量付费，�?Go 首月 $5，之�?$10/月，提供充裕的额度，并可可靠地访�?GLM-5.1、GLM-5、Kimi K2.5、Kimi K2.6、encode-v2-Pro、encode-v2-Omni、Qwen3.5 Plus、Qwen3.6 Plus、MiniMax M2.5 �?MiniMax M2.7 等开源模型�?,
  "go.faq.q4": "Go 多少钱？",
  "go.faq.a4.p1.beforePricing": "Go 费用�?,
  ...
  "go.faq.q8": "我可以在其他编程代理中使�?Go 吗？",
  "go.faq.a8": "可以，您可以在任何代理中使用 Go。请遵循您首选编程代理中的设置说明�?,

  "go.faq.q9": "免费模型�?Go 之间的区别是什么？",
  "go.faq.a9":
    "免费模型包含 Big Pickle 加上当时可用的促销模型，每天有 200 次请求的配额。Go 包含 GLM-5.1, GLM-5, Kimi K2.5、Kimi K2.6, encode-v2-Pro, encode-v2-Omni, Qwen3.5 Plus, Qwen3.6 Plus, MiniMax M2.5 �?MiniMax M2.7，并在滚动窗口（5 小时、每周和每月）内执行更高的请求配额，大致相当于每 5 小时 $12、每�?$30 和每�?$60（实际请求计数因模型和使用情况而异）�?,

  "zen.api.error.rateLimitExceeded": "超出速率限制。请稍后重试�?,
  "zen.api.error.modelNotSupported": "不支持模�?{{model}}",
  "zen.api.error.modelFormatNotSupported": "格式 {{format}} 不支持模�?{{model}}",
  ...
  "zen.api.error.invalidApiKey": "无效�?API 密钥�?,
  "zen.api.error.subscriptionQuotaExceeded": "超出订阅配额。请�?{{retryIn}} 后重试�?,
  ...
  "zen.api.error.modelDisabled": "模型已禁�?,
  "zen.api.error.trialEnded": "{{model}} 的限免活动已结束。您可以订阅 Encode Go 继续使用该模�?- {{link}}",

  "black.meta.title": "Encode Black | 访问全球顶尖编程模型",
  "black.meta.description": "通过 Encode Black 订阅计划使用 Claude, GPT, Gemini 等模型�?,
  "black.hero.title": "访问全球顶尖编程模型",
  "black.hero.subtitle": "包括 Claude, GPT, Gemini �?,
  "black.title": "Encode Black | 定价",
  "black.paused": "Black 订阅已暂时暂停注册�?,
  "black.plan.icon20": "Black 20 计划",
  "black.plan.icon100": "Black 100 计划",
  "black.plan.icon200": "Black 200 计划",
  "black.plan.multiplier100": "用量�?Black 20 �?5 �?,
  "black.plan.multiplier200": "用量�?Black 20 �?20 �?,
  "black.price.perMonth": "/ �?,
  "black.price.perPersonBilledMonthly": "每人每月",
  "black.terms.1": "您的订阅不会立即开�?,
  "black.terms.2": "您将被加入候补名单，并很快激�?,
  "black.terms.3": "您的卡只会在订阅激活时扣费",
  "black.terms.4": "适用使用限制，高度自动化的使用可能会更快达到限制",
  "black.terms.5": "订阅仅限个人，团队请联系企业�?,
  "black.terms.6": "未来可能会调整限制或停止计划",
  "black.terms.7": "随时取消订阅",
  "black.action.continue": "继续",
  "black.finePrint.beforeTerms": "显示价格不含�?,
  "black.finePrint.terms": "服务条款",
  "black.workspace.title": "Encode Black | 选择工作�?,
  "black.workspace.selectPlan": "为此计划选择一个工作区",
  "black.workspace.name": "工作�?{{n}}",
  "black.subscribe.title": "订阅 Encode Black",
  "black.subscribe.paymentMethod": "付款方式",
  "black.subscribe.loadingPaymentForm": "正在加载付款表单...",
  "black.subscribe.selectWorkspaceToContinue": "选择一个工作区以继�?,
  "black.subscribe.failurePrefix": "哎呀�?,
  "black.subscribe.error.generic": "发生错误",
  "black.subscribe.error.invalidPlan": "无效的计�?,
  "black.subscribe.error.workspaceRequired": "缺少工作�?ID",
  "black.subscribe.error.alreadySubscribed": "此工作区已有订阅",
  "black.subscribe.processing": "处理�?..",
  "black.subscribe.submit": "订阅 ${{plan}}",
  "black.subscribe.form.chargeNotice": "您的卡只会在订阅激活时扣费",
  "black.subscribe.success.title": "您已加入 Encode Black 候补名单",
  ...
  "workspace.newUser.feature.quality.title": "最高质�?,
  "workspace.newUser.feature.quality.body": "访问配置为最佳性能的模�?- 无需降级或路由到更便宜的提供商�?,
  "workspace.newUser.feature.lockin.title": "无锁�?,
  "workspace.newUser.feature.lockin.body":
    "�?Zen 与任何编程代理结合使用，并在需要时继续�?Encode 中使用其他提供商�?,
  ...
  "workspace.newUser.step.login.after": "并选择 Encode",
  "workspace.newUser.step.pasteKey": "粘贴您的 API 密钥",
  "workspace.newUser.step.models.before": "启动 Encode 并运�?,
  ...
  "workspace.models.table.enabled": "已启�?,

  "workspace.providers.title": "自带密钥 (BYOK)",
  "workspace.providers.subtitle": "配置您自己的 AI 提供�?API 密钥�?,
  ...
  "workspace.usage.empty": "发起第一�?API 调用以开始�?,
  ...
  "workspace.members.inviting": "正在邀�?..",
  ...
  "workspace.members.noLimitLowercase": "无限�?,
  "workspace.members.invited": "已邀�?,
  ...
  "workspace.billing.add": "充�?$",
  "workspace.billing.enterAmount": "输入金额",
  "workspace.billing.loading": "加载�?..",
  "workspace.billing.addAction": "充�?,
  "workspace.billing.addBalance": "充值余�?,
  "workspace.billing.alipay": "支付�?,
  "workspace.billing.wechat": "微信支付",
  "workspace.billing.linkedToStripe": "已关�?Stripe",
  ...
  "workspace.redeem.title": "兑换优惠�?,
  "workspace.redeem.subtitle": "兑换优惠码以领取充值额度或权益�?,
  "workspace.redeem.placeholder": "输入优惠�?,
  "workspace.redeem.redeem": "兑换",
  "workspace.redeem.redeeming": "兑换�?..",
  ...
  "workspace.payments.type.credit": "充�?,
  ...
  "workspace.black.subscription.message": "您已订阅 Encode Black，价格为每月 ${{plan}}�?,
  ...
  "workspace.black.waitlist.joined": "您已加入每月 ${{plan}} �?Encode Black 计划候补名单�?,
  "workspace.black.waitlist.ready": "我们已准备好将您加入每月 ${{plan}} �?Encode Black 计划�?,
  "workspace.black.waitlist.leave": "退出候补名单",
  "workspace.black.waitlist.leaving": "正在退�?..",
  ...
  "workspace.lite.time.fewSeconds": "几秒�?,
  "workspace.lite.subscription.message": "您已订阅 Encode Go�?,
  ...
  "workspace.lite.subscription.resetsIn": "重置�?,
  "workspace.lite.subscription.useBalance": "达到使用限额后使用您的可用余�?,
  "workspace.lite.subscription.selectProvider":
    "在你�?encode 配置中选择「Encode Go」作为提供商，即可使�?Go 模型�?,
  "workspace.lite.black.message": "您当前已订阅 Encode Black 或在候补名单中。如需切换�?Go，请先取消订阅�?,
  "workspace.lite.other.message": "此工作区中的另一位成员已经订阅了 Encode Go。每个工作区只有一名成员可以订阅�?,
  "workspace.lite.promo.description":
    "Encode Go 起价�?{{price}}，之�?$10/月，并提供对流行开放编码模型的可靠访问，同时享有充裕的使用限额�?,
  ...
  "workspace.lite.promo.subscribing": "正在重定�?..",
  "workspace.lite.promo.otherMethods": "其他付款方式",
  "workspace.lite.promo.selectMethod": "选择付款方式",

  "download.title": "Encode | 下载",
  "download.meta.description": "下载适用�?macOS, Windows, �?Linux �?Encode",
  "download.hero.title": "下载 Encode",
  "download.hero.subtitle": "适用�?macOS, Windows, �?Linux �?Beta �?,
  "download.hero.button": "下载 {{os}} �?,
  "download.section.terminal": "Encode 终端",
  "download.section.desktop": "Encode 桌面�?(Beta)",
  "download.section.extensions": "Encode 扩展",
  "download.section.integrations": "Encode 集成",
  ...
  "download.faq.a3.beforeLocal":
    "不一定，但可能需要。如果您想将 Encode 连接到付费提供商，您需�?AI 订阅，尽管您可以配合",
  "download.faq.a3.localLink": "本地模型",
  "download.faq.a3.afterLocal.beforeZen": "免费使用。虽然我们鼓励用户使�?,
  "download.faq.a3.afterZen": "，但 Encode 支持所有主流提供商，如 OpenAI, Anthropic, xAI 等�?,

  "download.faq.a5.p1": "Encode �?100% 免费使用的�?,
  "download.faq.a5.p2.beforeZen":
    "任何额外费用都来自您对模型提供商的订阅。虽�?Encode 支持任何模型提供商，但我们建议使�?,
  "download.faq.a5.p2.afterZen": "�?,

  "download.faq.a6.p1": "只有当您�?Encode 中创建分享链接时，您的数据和信息才会被存储�?,
  "download.faq.a6.p2.beforeShare": "了解更多关于",
  "download.faq.a6.shareLink": "分享页面",

  "enterprise.title": "Encode | 面向组织�?Encode 企业版解决方�?,
  "enterprise.meta.description": "联系 Encode 获取企业版解决方�?,
  "enterprise.hero.title": "您的代码属于�?,
  "enterprise.hero.body1":
    "Encode 在您的组织内部安全运行，不存储任何数据或上下文，也没有许可限制或所有权主张。您可以先与团队开始试用，然后通过集成 SSO 和内�?AI 网关将其部署到整个组织�?,
  ...
  "enterprise.form.message.placeholder": "我们需要帮�?..",
  "enterprise.form.send": "发�?,
  "enterprise.form.sending": "正在发�?..",
  ...
  "enterprise.faq.q1": "什么是 Encode 企业版？",
  "enterprise.faq.a1":
    "Encode 企业版专为那些希望确保代码和数据永远不离开其基础设施的组织而设计。它通过使用集中式配置，与您�?SSO 和内�?AI 网关集成来实现这一点�?,
  "enterprise.faq.q2": "如何开始使�?Encode 企业版？",
  "enterprise.faq.a2":
    "只需从您的团队内部试用开始即可。Encode 默认不存储您的代码或上下文数据，使得入门非常容易。然后联系我们讨论定价和实施选项�?,
  "enterprise.faq.q3": "企业版定价如何运作？",
  "enterprise.faq.a3":
    "我们提供按席位计费的企业定价。如果您拥有自己�?LLM 网关，我们不收取 token 使用费。如需了解更多详情，请联系我们获取基于您组织需求的定制报价�?,
  "enterprise.faq.q4": "Encode 企业版安全吗�?,
  "enterprise.faq.a4":
    "是的。Encode 不存储您的代码或上下文数据。所有处理均在本地进行，或通过直接 API 调用您的 AI 提供商。通过集中配置�?SSO 集成，您的数据始终保留在您组织的基础设施内�?,

  "brand.title": "Encode | 品牌",
  "brand.meta.description": "Encode 品牌指南",
  "brand.heading": "品牌指南",
  "brand.subtitle": "帮助您使�?Encode 品牌的资源和资产�?,
  "brand.downloadAll": "下载所有资�?,

  "changelog.title": "Encode | 更新日志",
  "changelog.meta.description": "Encode 发布说明和更新日�?,
  "changelog.hero.title": "更新日志",
  "changelog.hero.subtitle": "Encode 的新更新和改�?,
