...
export const dict = {
  ...
  "temp.feature.zen.beforeLink": "�?OpenCode 提供�?,
  ...
  "temp.screenshot.caption": "使用 Tokyonight 主题�?OpenCode TUI",
  "temp.screenshot.alt": "使用 Tokyonight 主题�?OpenCode TUI",
  ...
  "home.growth.body":
    "拥有超过 <strong>{{stars}}</strong> �?GitHub Star�?strong>{{contributors}}</strong> 位贡献者，以及超过 <strong>{{commits}}</strong> 次提交，OpenCode 每月被超�?<strong>{{monthlyUsers}}</strong> 名开发者使用并信赖�?,
  ...
  "home.faq.a1": "OpenCode 是一个开源代理，帮助您使用任�?AI 模型编写和运行代码。它提供终端界面、桌面应用及 IDE 扩展�?,
  ...
  "home.faq.a4.p1":
    "可以，OpenCode 支持所有主流提供商的订阅计划。您可以使用您的 Claude Pro/Max, ChatGPT Plus/Pro, �?GitHub Copilot 订阅�?,
  "home.faq.q5": "OpenCode 只能在终端使用吗�?,
  "home.faq.a5.beforeDesktop": "不再是了！OpenCode 现在也提�?,
  "home.faq.a5.desktop": "桌面端应�?,
  "home.faq.a5.and": "�?,
  "home.faq.a5.web": "网页�?,
  "home.faq.q6": "OpenCode 多少钱？",
  "home.faq.a6": "OpenCode �?100% 免费使用的。它还自带一组免费模型。如果您连接其他提供商，可能会产生额外费用�?,
  "home.faq.q7": "数据和隐私如何？",
  ...
  "home.faq.a8.p1": "是的，OpenCode 是完全开源的。源代码公开�?,
  "home.faq.a8.p2": "遵循",
  ...
  "home.zenCta.body":
    "Zen 为您提供一组精选的 AI 模型，这些模型经�?OpenCode 专门针对编程代理的测试和基准测试。无需担心不同提供商之间不稳定的性能和质量，直接使用行之有效的验证模型�?,
  "home.zenCta.link": "了解 Zen",

  "zen.title": "OpenCode Zen | 为编程代理精选的可靠、优化模�?,
  "zen.hero.title": "为编程代理打造的可靠、优化模�?,
  "zen.hero.body":
    "Zen 为您提供一组精选的 AI 模型，这些模型经�?OpenCode 专门针对编程代理的测试和基准测试。无需担心不稳定的性能和质量，直接使用行之有效的验证模型�?,
  ...
  "zen.faq.a4.p3": "为覆盖成本，OpenCode 仅收取少量支付处理费，每充�?$20 收取 $1.23�?,
  "zen.faq.q5": "数据和隐私如何？",
  ...
  "zen.faq.a8":
    "虽然 Zen �?OpenCode 配合效果极佳，但您可以在任何代理中使�?Zen。请按照您首选编程代理中的设置说明进行操作�?,
  ...
  "go.problem.body":
    "我们致力于将 OpenCode 体验带给尽可能多的人。OpenCode Go 是一款低成本订阅服务：首�?$5，之�?$10/月。它提供充裕的额度，并让您能可靠地使用最强大的开源模型�?,
  "go.problem.subtitle": " ",
  ...
  "go.how.body": "Go 起价为首�?$5，之�?$10/月。您可以将其�?OpenCode 或任何代理搭配使用�?,
  ...
  "zen.api.error.trialEnded": "{{model}} 的限免活动已结束。您可以订阅 OpenCode Go 继续使用该模�?- {{link}}",
  ...
  "black.workspace.title": "OpenCode Black | 选择工作�?,
  ...
  "workspace.newUser.feature.lockin.body":
    "�?Zen 与任何编程代理结合使用，并在需要时继续�?OpenCode 中使用其他提供商�?,
  ...
  "workspace.keys.subtitle": "管理访问 OpenCode 服务�?API 密钥�?,
  ...
  "workspace.black.waitlist.joined": "您已加入每月 ${{plan}} �?OpenCode Black 计划候补名单�?,
  "workspace.black.waitlist.ready": "我们已准备好将您加入每月 ${{plan}} �?OpenCode Black 计划�?,
  ...
  "workspace.lite.subscription.selectProvider":
    "在你�?opencode 配置中选择「OpenCode Go」作为提供商，即可使�?Go 模型�?,
  "workspace.lite.black.message": "您当前已订阅 OpenCode Black 或在候补名单中。如需切换�?Go，请先取消订阅�?,
  "workspace.lite.other.message": "此工作区中的另一位成员已经订阅了 OpenCode Go。每个工作区只有一名成员可以订阅�?,
  "workspace.lite.promo.description":
    "OpenCode Go 起价�?{{price}}，之�?$10/月，并提供对流行开放编码模型的可靠访问，同时享有充裕的使用限额�?,
  ...
  "download.meta.description": "下载适用�?macOS, Windows, �?Linux �?OpenCode",
  ...
  "download.section.desktop": "OpenCode 桌面�?(Beta)",
  ...
  "download.faq.a3.beforeLocal":
    "不一定，但可能需要。如果您想将 OpenCode 连接到付费提供商，您需�?AI 订阅，尽管您可以配合",
  ...
  "download.faq.a5.p1": "OpenCode �?100% 免费使用的�?,
  "download.faq.a5.p2.beforeZen":
    "任何额外费用都来自您对模型提供商的订阅。虽�?OpenCode 支持任何模型提供商，但我们建议使�?,
  "download.faq.a5.p2.afterZen": "�?,

  "download.faq.a6.p1": "只有当您�?OpenCode 中创建分享链接时，您的数据和信息才会被存储�?,
  "download.faq.a6.p2.beforeShare": "了解更多关于",
  "download.faq.a6.shareLink": "分享页面",

  "enterprise.title": "OpenCode | 面向组织�?OpenCode 企业版解决方�?,
  "enterprise.meta.description": "联系 OpenCode 获取企业版解决方�?,
  "enterprise.hero.title": "您的代码属于�?,
  "enterprise.hero.body1":
    "OpenCode 在您的组织内部安全运行，不存储任何数据或上下文，也没有许可限制或所有权主张。您可以先与团队开始试用，然后通过集成 SSO 和内�?AI 网关将其部署到整个组织�?,
  ...
  "enterprise.faq.a1":
    "OpenCode 企业版专为那些希望确保代码和数据永远不离开其基础设施的组织而设计。它通过使用集中式配置，与您�?SSO 和内�?AI 网关集成来实现这一点�?,
  "enterprise.faq.q2": "如何开始使�?OpenCode 企业版？",
  "enterprise.faq.a2":
  ...
  "enterprise.faq.a4":
    "是的。OpenCode 不存储您的代码或上下文数据。所有处理均在本地进行，或通过直接 API 调用您的 AI 提供商。通过集中配置�?SSO 集成，您的数据始终保留在您组织的基础设施内�?,

  "brand.title": "OpenCode | 品牌",
  "brand.meta.description": "OpenCode 品牌指南",
  "brand.heading": "品牌指南",
  "brand.subtitle": "帮助您使�?OpenCode 品牌的资源和资产�?,
  "brand.downloadAll": "下载所有资�?,

  "changelog.title": "OpenCode | 更新日志",
  "changelog.meta.description": "OpenCode 发布说明和更新日�?,
  "changelog.hero.title": "更新日志",
  "changelog.hero.subtitle": "OpenCode 的新更新和改�?,
