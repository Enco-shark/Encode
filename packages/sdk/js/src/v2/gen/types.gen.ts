...
export type Config = {
  ...
  checkpoint?: {
    ...
    push_caps?: {
      ...
      notes?: number
      /**
       * Token cap for ยง10 Design decisions section of checkpoint.md (writer-side budget validation). Default: 3000.
       */
      design_decisions?: number
      /**
       * Token cap for ยง11 Open notes section of checkpoint.md (writer-side budget validation). Default: 800.
       */
      open_notes?: number
    }
    /**
     * Number of days after task done/abandoned before it's filtered out of `list({include_archived: false})`. Rows are NOT deleted โ€?see v9 for true GC. Default: 7.
     */
...
export type SessionPromptErrors = {
  ...
  404: NotFoundError
  /**
   * Conflict โ€?session resource is busy
   */
  409: ConflictError
}
